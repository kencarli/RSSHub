({ "81.cn":{ _name:"中国军网",
  ...
  "cninfo.com.cn":{ _name:"viewfinancial",
    www:[ { title:"巨潮资讯",
        docs:"https://docs.rsshub.app/routes/finance",
        source:[ "/*" ],
        target:"/viewfinancial/new/disclosure" } ] },
  "24me.cc":{ _name:"viewpics",
    ".":[ { title:"24me",
        docs:"https://docs.rsshub.app/routes/picture",
        source:[ "/mc:id.aspx" ],
        target:"/viewpics/24me/mc/:id" } ] },
  "5ikanhm.top":{ _name:"viewpics",
    ".":[ { title:"漫小肆漫画",
        docs:"https://docs.rsshub.app/routes/漫画",
        source:[ "/book/*" ],
        target:"/viewpics/book/:id" } ] },
  "867xe.com":{ _name:"viewpics",
    ".":[ { title:"867xe",
        docs:"https://docs.rsshub.app/routes/图片",
        source:[ "/867xe-tupianqu/YSE/*" ],
        target:"/viewpics/867xe-tupianqu" } ] },
  "taotu.org":{ _name:"viewpics",
    ".":[ { title:"taotu",
        docs:"https://docs.rsshub.app/routes/picture",
        source:[ "/*" ],
        target:"/viewpics/" } ] },
  "023vcc.com":{ _name:"viewpics",
    "3zx4":[ { title:"wangyouzipai",
        docs:"https://docs.rsshub.app/routes/图片",
        source:[ "/*" ],
        target:"/viewpics3zx4.023vcc.com/" } ] },
  "xman5.com":{ _name:"viewpics",
    ".":[ { title:"X漫",
        docs:"https://docs.rsshub.app/routes/X漫",
        source:[ "/mdetail/*" ],
        target:"/viewpics/mdetail/:id" } ] },
